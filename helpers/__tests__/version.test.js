...
describe("isGreaterThanOrEqualToVersion", () => {
  it("it should check if versions are greater than or equal to", () => {
    ...
    expect(isGreaterThanOrEqualToVersion(versionD, supportedVersion)).toEqual(true)
    expect(isGreaterThanOrEqualToVersion(versionD, versionC)).toEqual(true)
    expect(isGreaterThanOrEqualToVersion(versionC, versionD)).toEqual(false)
